...
const Login = () => {
  ...
  const { signInWithGoogle, sendPhoneOTP, mockLoginAsInstructor } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (email === 'leeleshlee08@gmail.com' && password === '1234') {
      mockLoginAsInstructor();
      toast({ title: 'Logged in successfully as Instructor!' });
