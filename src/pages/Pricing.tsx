...
import { Check, Star, Laptop, Zap, ShoppingCart } from 'lucide-react';
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  {addedToCart === plan.name && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
                      className="text-center text-green-500 text-sm font-medium flex items-center justify-center gap-1"
                    >
