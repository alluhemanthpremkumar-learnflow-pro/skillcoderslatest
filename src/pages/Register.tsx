...
const Register = () => {
  ...
  const [instructorData, setInstructorData] = useState({ name: '', email: '', password: '', bio: '' });
  ...
  const handleInstructorSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast({ title: 'Instructor application submitted', description: 'Your application is under review.' });
  };
        ...
        <div className="max-w-md mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.1 }} className="bg-card/80 backdrop-blur-xl rounded-2xl border border-border p-8 glow-border">
            ...
            <div className="space-y-3 mb-4">
              ...
              <motion.button initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} whileHover={{ scale: 1.02, x: 5 }} whileTap={{ scale: 0.98 }} onClick={handleGithubSignup} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-border bg-background/50 transition-all duration-300 hover:bg-muted hover:border-muted-foreground/50">
              ...
              <motion.button initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} whileHover={{ scale: 1.02, x: 5 }} whileTap={{ scale: 0.98 }} onClick={() => setShowPhoneSignup(!showPhoneSignup)} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-border bg-background/50 transition-all duration-300 hover:bg-primary/10 hover:border-primary/50">
